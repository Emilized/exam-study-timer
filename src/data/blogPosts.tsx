...
import { Clock, Smartphone, BookOpen, Brain, Coffee, Activity, Monitor, Lightbulb } from 'lucide-react';

export const blogPosts = [
  {
    slug: '25-minute-rule',
    title: 'Why the 25-Minute Rule Works Wonders',
    excerpt: 'Discover why breaking your study sessions into 25-minute intervals is the ultimate hack for your brain\'s attention span.',
    icon: Clock,
    color: 'indigo',
    content: (
      <>
  ...
  {
    slug: 'beat-exam-stress-phone-distractions',
    title: '5 Tested Ways to Beat Exam Stress and Phone Distractions',
    excerpt: 'Learn actionable strategies to manage your digital environment and crush exam anxiety.',
    icon: Smartphone,
    color: 'emerald',
    content: (
      <>
  ...
  {
    slug: 'optimize-night-study-sessions',
    title: 'How to Optimize Your Night Study Sessions',
    excerpt: 'Night owls can be incredibly productive. Discover how to protect your sleep while studying late.',
    icon: BookOpen,
    color: 'amber',
    content: (
      <>
  ...
  {
    slug: 'spaced-repetition-forgetting-curve',
    title: 'The Science of Spaced Repetition: Defeating the Forgetting Curve',
    excerpt: 'Stop cramming. Learn the scientific study method that builds genuine, long-lasting comprehension.',
    icon: Brain,
    color: 'blue',
    content: (
      <>
  ...
  {
    slug: 'nutrition-tips-cognitive-performance',
    title: 'Fueling Your Focus: Nutrition Tips for Peak Cognitive Performance',
    excerpt: 'Your brain is an energy-intensive organ. Here\'s what you should eat to sustain high-level focus.',
    icon: Coffee,
    color: 'rose',
    content: (
      <>
  ...
  {
    slug: 'preventing-academic-burnout',
    title: 'Recognizing and Preventing Academic Burnout',
    excerpt: 'Grinding until you drop is toxic. Learn to recognize the signs of burnout and protect your mental health.',
    icon: Activity,
    color: 'teal',
    content: (
      <>
  ...
  {
    slug: 'ultimate-high-focus-study-space',
    title: 'Designing the Ultimate High-Focus Study Space',
    excerpt: 'Where you study impacts how you study. Create an environment that naturally enhances your concentration.',
    icon: Monitor,
    color: 'purple',
    content: (
      <>
  ...
  },
  {
    ...
    excerpt: 'Stop mistaking recognition for understanding. Use this Nobel Prize-winning trick to master complex topics.',
    icon: Lightbulb,
    color: 'pink',
    content: (
      <>
