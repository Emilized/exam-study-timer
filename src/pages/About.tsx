      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="bg-slate-800 rounded-3xl p-8 md:p-12 shadow-2xl border border-slate-700">
          ...
          <div className="space-y-6 text-slate-300 leading-relaxed text-lg">
            ...
            <p>
              <strong>Built by Cognito Code in Bacolod, PH.</strong> We are a passionate team dedicated to crafting free, high-quality, and reliable software tools for learners and creative minds. Thank you for making us a part of your daily study routine!
            </p>
          </div>
        </div>
      </div>
